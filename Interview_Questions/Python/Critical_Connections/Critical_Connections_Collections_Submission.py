...
class Solution(object):
	...
	'''
Runtime: 3411 ms, faster than 37.93% of Python3 online submissions for Critical Connections in a Network.
Memory Usage: 75.8 MB, less than 65.13% of Python3 online submissions for Critical Connections in a Network.
'''
